...
本项目旨在收集、整理、分析和可视化中国国家地理标志产品数据。通过数据分析、数据可视化和文本挖掘技术，探索地理标志产品的地理分布特征和感官描述特点。

## 项目概述

中国国家地理标志产品是指产自特定地域，所具有的质量、声誉或其他特性本质上取决于该产地的自然因素和人文因素，经审核批准以地理名称进行命名的产品。本项目对官方发布的地理标志保护产品批准公告进行了系统性的数据收集和分析。
